...
const imagens = ['./IMAGENS/foto1.jpg', './IMAGENS/foto2.jpg', 
'./IMAGENS/foto3.jpg', './IMAGENS/foto4.jpg', './IMAGENS/foto5.jpg', 
'./IMAGENS/foto6.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../JOGO_MEMORIA_JOSE/id/${i}/100`);
 
let fundo = `./IMAGENS/capa2.jpg`;
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogo
    ...
    document.querySelector('#matematica').style.color = '#000';
    ...
    document.body.style.backgroundImage = "url('./IMAGENS/background4.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('#btInicio').style.color = '#000';
    document.querySelector('#btInicio').style.color = '#FFFF00';
    document.querySelector('#matematica').style.color = '#FFFF00';
    document.querySelector('#btInicio').style.backgroundColor = '#0101DF';
    document.querySelector('.titulo').textContent ='Parabéns José!';
    document.querySelector('.titulo').style.backgroundColor ='#0101DF';  
    document.querySelector('#matematica').style.backgroundColor = '#0101DF';   
    document.body.style.backgroundImage = "url('./IMAGENS/background5.jpg')";
    timerDoJogo.stop(); 
}     
